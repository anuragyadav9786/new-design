...
export default function RedesignHero() {
  ...
  return (
    <section className="relative flex min-h-[90vh] w-full flex-col justify-center overflow-hidden bg-[var(--tf-bg)] py-20">
      <div className="mx-auto grid w-full max-w-[1280px] grid-cols-1 items-center gap-16 px-[5vw] lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
        <div className="animate-fade-up">
          <span className="inline-block rounded-full bg-[var(--tf-bg-soft)] px-4 py-1.5 text-xs font-semibold tracking-[0.15em] text-[var(--tf-blue)]">
            INVEST WITH PURPOSE
          </span>
          <h1 className="mt-6 font-sans text-[clamp(48px,6vw,88px)] font-bold leading-[1.05] tracking-tight text-[var(--tf-navy)]">
            Your Goals.
            <br />
            Your Money.
            <br />
          ...
          <p className="mt-6 max-w-md text-[17px] leading-relaxed text-[var(--tf-text-secondary)]">
