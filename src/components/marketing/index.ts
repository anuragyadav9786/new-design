...
export { default as FinalCta } from "@/components/redesign/final-cta";
export { default as GoalCarousel } from "@/components/redesign/goal-carousel";
export { default as GoalGrid } from "@/components/redesign/goal-grid";
export { default as Hero } from "@/components/redesign/hero";
export { default as HowItWorks } from "@/components/redesign/how-it-works";
export { default as Insights } from "@/components/redesign/insights";
export { default as ProblemSolution } from "@/components/redesign/problem-solution";
export { default as ProductShowcase } from "@/components/redesign/product-showcase";
